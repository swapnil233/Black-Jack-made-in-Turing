...
Font.Draw ("Dealer/PC:", 50, maxy div 2 + 50, font3, yellow)
...
procedure game
    ...
    % Draw.Text (intstr(player.total), 190, 39, font4, black)
...
%HIT and STAND
    ...
    elsif player.total > computer.total and player.total < 21 then
	delay (1000)
	put "YOU WIN!"
