...
procedure printCard (x : hand, suit : int, face : int)
	...
	if x.cardCount < 3 then
	    delay (300)
	    Pic.Draw (globalPicDeck (suit, face), maxx div 3 + 80 * x.cardCount, 80, 0)

	    if x.cardCount = 1 then
		delay (500)
		Pic.Draw (back, maxx div 3 + 80 * x.cardCount, 80, 0)
	    end if
	...
	if x.cardCount < 3 then
	    delay (300)
	    Pic.Draw (globalPicDeck (suit, face), maxx div 3 + 80 * x.cardCount, 250, 0)

	    if x.cardCount = 1 then
		Pic.Draw (back, maxx div 3 + 80 * x.cardCount, 250, 0)
	    end if
...
proc loan
    ...
    loop
	Mouse.Where (Mx, My, button)
	if Mx > 465 and Mx < 500 and My > 365 and My < 400 and button = 1 then
...
procedure game
    ...
    Draw.Box (30, 230, 610, 365, black)
    Draw.Box (30, 60, 610, 195, black)
    %Draw.Line (0, maxy div 2 - 10, 800, maxy div 2 - 10, black)

    betmoney
    Font.Draw ("Dealer:", 50, maxy div 2 + 100, font3, yellow)
    delay (100)
	...
	if Mx > 290 and Mx < 365 and My > 78 and My < 175 then
	    delay (25)
	    Pic.Draw (globalPicDeck (player.cardSuit (2), player.cardFace (2)), maxx div 3 + 80, 80, 0)
	else
	    Pic.Draw (back, maxx div 3 + 80, 80, 0)
	end if
	%MOUSEOVER *****************************************************************************************

	%HIT & STAND ***************************************************************************************
	if Mx > 245 and Mx < 300 and My > 30 and My < 60 and button = 1 then %If I click hit
	    delay (50)
	    draw (player)
	...
	delay (800)
	Pic.Draw (globalPicDeck (computer.cardSuit (2), computer.cardFace (2)), maxx div 3 + 80, 250, 0)
	delay (1000)
