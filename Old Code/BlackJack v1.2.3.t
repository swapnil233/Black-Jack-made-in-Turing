...
% my idea: loan : 12:13pm dec 16, 2016
...
procedure printCard (x : hand, suit : int, face : int)
	...
	if x.cardCount < 3 then
		...
		%     Mouse.Where (Mx, My, button)
		%
		%     if Mx > 240 and Mx < 320 and My > 70 and My < 170 then
		%         Pic.Draw (globalPicDeck (suit, face), maxx div 3 + 30 * x.cardCount, 80, 0)
		%     else
		%         Pic.Draw (back, maxx div 3 + 30 * x.cardCount, 80, 0)
		%     end if
...
procedure mouseOver
	...
	if Mx > 340 and Mx < 420 and My > 70 and My < 170 then
	    Pic.Draw (globalPicDeck (player.cardSuit (2), player.cardFace (2)), maxx div 3 + 30, 80, 0)
	else
...
procedure game
	...
	Draw.Text (intstr (computer.total), 132, 248, font3, yellow)
	delay (800)
	Pic.Draw (globalPicDeck (computer.cardSuit (2), computer.cardFace (2)), maxx div 3 + 30, 200, 0)
    end if
	...
	Pic.Draw (globalPicDeck (computer.cardSuit (2), computer.cardFace (2)), maxx div 3 + 30, 200, 0)
	Draw.Text (intstr (computer.total), 132, 248, font3, yellow)
	Font.Draw ("You Win", 420, 100, font3, brightred)
	mymoney := mymoney + bet
	...
	Font.Draw ("Computer Wins", 420, 240, font3, brightred)
	mymoney := mymoney - bet
	put "Your wallet: ", mymoney
...
%323853135  0P9O8i7u6y5t4r3e2w1q
