...
%      loop
%          Mouse.Where (Mx, My, button)
%         if Mx > 348 and Mx < 420 and My > 80 and My < 175 then
%              draw ()
%          end if
%      end loop
% %
...
%Draw.FillBox (200, 400, 300, 500, black)
...
procedure game
    ...
    %Font.Draw ("Player Total:", 50, 40, font4, black)
    Draw.Text (intstr (player.total), 193, 100, font4, black)
	...
	loop
	    ...
	    draw (computer)
	    put ""
	    put "Computer New Total: ", computer.total, " | " ..
